...
.. code-block:: shell
    ...
    python scratchpad/finrl/prefilter-finrl.py
...
def main():
    ...
    min_prefilter_liquidity = 250_000
    ...
    combined_output_fname = Path(f"{cache_path}/{chain_id.get_slug()}-price-tvl-prefiltered.csv")
